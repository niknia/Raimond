...
import { getMantineTheme, IRANSansX } from '@dkd-font-factory';
...
export function createMantineTheme({
	...
	const theme = createTheme({
		colors: {
		  ...colors, // شامل primary، secondary و tertiary
		  dark: [
		...
		...getMantineTheme(IRANSansX),
		//fontFamily:"Roboto",
		headings: { fontFamily: "IRANSansX" },
		defaultRadius: "md",
		other: {
	...
	return mergeMantineTheme(DEFAULT_THEME, theme);
}
