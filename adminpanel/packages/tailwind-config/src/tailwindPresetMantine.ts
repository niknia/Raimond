import { DEFAULT_THEME, mergeMantineTheme, type MantineThemeColorsOverride, type MantineBreakpointsValues } from "@mantine/core";
...
export default function tailwindPresetMantine(options: TailwindPresetMantineOptions = {}): Config {
    ...
    theme: {
      extend: {
        ...
        colors: {
          ...
          ...generateVariantSpecificSecondaryColors(),
          ...generateVariantSpecificTertiaryColors(),
...
function generatePrimaryColors(): Record<string, Record<string, string>> {
  return {
    primary: {
      50: "rgb(from var(--mantine-color-primary-0) r g b / <alpha-value>)",
      100: "rgb(from var(--mantine-color-primary-1) r g b / <alpha-value>)",
      200: "rgb(from var(--mantine-color-primary-2) r g b / <alpha-value>)",
      300: "rgb(from var(--mantine-color-primary-3) r g b / <alpha-value>)",
      400: "rgb(from var(--mantine-color-primary-4) r g b / <alpha-value>)",
      500: "rgb(from var(--mantine-color-primary-5) r g b / <alpha-value>)",
      600: "rgb(from var(--mantine-color-primary-6) r g b / <alpha-value>)",
      700: "rgb(from var(--mantine-color-primary-7) r g b / <alpha-value>)",
      800: "rgb(from var(--mantine-color-primary-8) r g b / <alpha-value>)",
      900: "rgb(from var(--mantine-color-primary-9) r g b / <alpha-value>)",
      DEFAULT: "rgb(from var(--mantine-color-primary-filled) r g b / <alpha-value>)",
    },
  };
}

function generateSecondaryColors(): Record<string, Record<string, string>> {
  return {
    secondary: {
      50: "rgb(from var(--mantine-color-secondary-0) r g b / <alpha-value>)",
      100: "rgb(from var(--mantine-color-secondary-1) r g b / <alpha-value>)",
      200: "rgb(from var(--mantine-color-secondary-2) r g b / <alpha-value>)",
      300: "rgb(from var(--mantine-color-secondary-3) r g b / <alpha-value>)",
      400: "rgb(from var(--mantine-color-secondary-4) r g b / <alpha-value>)",
      500: "rgb(from var(--mantine-color-secondary-5) r g b / <alpha-value>)",
      600: "rgb(from var(--mantine-color-secondary-6) r g b / <alpha-value>)",
      700: "rgb(from var(--mantine-color-secondary-7) r g b / <alpha-value>)",
      800: "rgb(from var(--mantine-color-secondary-8) r g b / <alpha-value>)",
      900: "rgb(from var(--mantine-color-secondary-9) r g b / <alpha-value>)",
      DEFAULT: "rgb(from var(--mantine-color-secondary-filled) r g b / <alpha-value>)",
    },
  };
}

function generateTertiaryColors(): Record<string, Record<string, string>> {
  return {
    tertiary: {
      50: "rgb(from var(--mantine-color-tertiary-0) r g b / <alpha-value>)",
      100: "rgb(from var(--mantine-color-tertiary-1) r g b / <alpha-value>)",
      200: "rgb(from var(--mantine-color-tertiary-2) r g b / <alpha-value>)",
      300: "rgb(from var(--mantine-color-tertiary-3) r g b / <alpha-value>)",
      400: "rgb(from var(--mantine-color-tertiary-4) r g b / <alpha-value>)",
      500: "rgb(from var(--mantine-color-tertiary-5) r g b / <alpha-value>)",
      600: "rgb(from var(--mantine-color-tertiary-6) r g b / <alpha-value>)",
      700: "rgb(from var(--mantine-color-tertiary-7) r g b / <alpha-value>)",
      800: "rgb(from var(--mantine-color-tertiary-8) r g b / <alpha-value>)",
      900: "rgb(from var(--mantine-color-tertiary-9) r g b / <alpha-value>)",
      DEFAULT: "rgb(from var(--mantine-color-tertiary-filled) r g b / <alpha-value>)",
    },
  };
}
...
function generateVariantSpecificSecondaryColors(): Record<string, string> {
  return {
    "secondary-filled": "rgb(from var(--mantine-secondary-color-filled) r g b / <alpha-value>)",
    "secondary-filled-hover": "var(--mantine-secondary-color-filled-hover)",
    "secondary-light": "var(--mantine-secondary-color-light)",
    "secondary-light-hover": "var(--mantine-secondary-color-light-hover)",
    "secondary-light-color": "rgb(from var(--mantine-secondary-color-light-color) r g b / <alpha-value>)",
    "secondary-outline": "rgb(from var(--mantine-secondary-color-outline) r g b / <alpha-value>)",
    "secondary-outline-hover": "var(--mantine-secondary-color-outline-hover)",
  };
}

function generateVariantSpecificTertiaryColors(): Record<string, string> {
  return {
    "tertiary-filled": "rgb(from var(--mantine-tertiary-color-filled) r g b / <alpha-value>)",
    "tertiary-filled-hover": "var(--mantine-tertiary-color-filled-hover)",
    "tertiary-light": "var(--mantine-tertiary-color-light)",
    "tertiary-light-hover": "var(--mantine-tertiary-color-light-hover)",
    "tertiary-light-color": "rgb(from var(--mantine-tertiary-color-light-color) r g b / <alpha-value>)",
    "tertiary-outline": "rgb(from var(--mantine-tertiary-color-outline) r g b / <alpha-value>)",
    "tertiary-outline-hover": "var(--mantine-tertiary-color-outline-hover)",
  };
}
