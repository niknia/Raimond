...
// Example component showing how to use Persian fonts with Tailwind CSS
export default function FarsiExample() {
  return (
    <div className="container mx-auto p-8 rtl">
      <h1 className="text-3xl font-vazirmatn font-bold mb-6">
        نمونه استفاده از فونت‌های فارسی با Tailwind CSS
      </h1>
