        ...
        while (reader.Read())
        {
            switch (reader.TokenKind)
            {
                ...
                case HtmlTokenKind.Tag:
                    ...
                    readText &= !tag.Equals("script", StringComparison.OrdinalIgnoreCase) &&
                ...
                case HtmlTokenKind.EndTag:
                    ...
                    if (endTag.Equals("p", StringComparison.OrdinalIgnoreCase) ||
                        endTag.Equals("br", StringComparison.OrdinalIgnoreCase))
                    {
                        sb.AppendLine();
                    }
