...
public class UowAsyncInterceptor(IUnitOfWork unitOfWork) : IAsyncInterceptor
{
    ...
    /// <summary>
    /// Asynchronous interceptor with no return value
    /// </summary>
    /// <param name="invocation"></param>
    ...
    /// <summary>
    /// Asynchronous interceptor with return value
    /// </summary>
    ...
    /// <summary>
    /// Asynchronous interceptor transaction handling - no return value
    /// </summary>
    /// <param name="invocation"></param>
    /// <param name="attribute"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Asynchronous interceptor transaction handling - with return value
    /// </summary>
    /// <typeparam name="TResult"></typeparam>
    /// <param name="invocation"></param>
    /// <param name="attribute"></param>
    ...
    /// <summary>
    /// Asynchronous interceptor without transaction handling - no return value
    /// </summary>
    /// <param name="invocation"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Asynchronous interceptor without transaction handling - with return value
    /// </summary>
    /// <typeparam name="TResult"></typeparam>
    /// <param name="invocation"></param>
    /// <returns></returns>
