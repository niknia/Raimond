using Dkd.Infra.Repository.EfCore.Extensions;
using Microsoft.EntityFrameworkCore.Query;

namespace Dkd.Infra.Repository.EfCore;

/// <summary>
/// Default, full-featured Entity Framework repository implementation
/// </summary>
  ...
  where TEntity : EfEntity, new()
{
    ...
    {
        var rows = 0;
        // Check if there is an entity with the same Id in the current context
