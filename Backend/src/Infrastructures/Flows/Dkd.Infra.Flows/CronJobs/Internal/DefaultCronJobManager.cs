    ...
    : ICronJobManager<TContext>
{
        ...
        CancellationToken ct = default)
    {
        ...
        failedJobs.TryRemove(cronJob.Id, out _);
    ...
    {
        return TryGetCronExpression(expression, true, out _);
    }

    public bool IsValidTimezone(string? timezone)
    {
        return TryGetTimezone(timezone, out _);
    }
    ...
    private bool TryGetCronExpression(string expression, bool validateInterval,
