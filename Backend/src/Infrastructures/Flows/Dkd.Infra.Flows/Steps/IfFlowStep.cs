...
[FlowStep(
    Title = "If",
    IconImage =
        "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path d='M600-160v-80H440v-200h-80v80H80v-240h280v80h80v-200h160v-80h280v240H600v-80h-80v320h80v-80h280v240H600zm80-80h120v-80H680v80zM160-440h120v-80H160v80zm520-200h120v-80H680v80zm0 400v-80 80zM280-440v-80 80zm400-200v-80 80z'/></svg>",
    IconColor = "#3389ff",
    Display = "Conditions",
...
public sealed record IfFlowStep : FlowStep, IEquatable<IfFlowStep>
{
    ...
    [Editor(FlowStepEditor.None)] public Guid? ElseStepId { get; set; }
