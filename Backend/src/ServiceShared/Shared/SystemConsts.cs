...
public static class GeneralConsts
{
    ...
    public const string UserValidatedInfoKeyPrefix = "raimond:users:validatedinfo";
    public const string RoleMenuCodesCacheKey = "raimond:role:menus:codes";
}
...
public static class NodeConsts
{
    ...
    public const string SmsApiKey = "SmsSettings:ApiKey";
    public const string SmsApiUri = "SmsSettings:BaseUrl";
}
