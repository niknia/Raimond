...
namespace Dkd.Shared.WebApi.Middleware;
...
public class CustomExceptionHandlerMiddleware(RequestDelegate next, IWebHostEnvironment env, ILogger<CustomExceptionHandlerMiddleware> logger)
{
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        var detial = "Demo Environment, operations not allowed";
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var detial = env.IsDevelopment() ? exception.GetDetail() : $"System Exception, please contact administrator({eventId})";
