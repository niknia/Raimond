using Dkd.Shared.WebApi.Authentication.Basic;
using Dkd.Shared.WebApi.Authentication.Bearer;
using Dkd.Shared.WebApi.Authentication.Hybrid;
        ...
        Services
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.Events = new JwtBearerEvents
                {
                    ...
                    {
                        //If it is expired, add the act parameter to http heard
                    ...
                    //Called after Token verification is passed
