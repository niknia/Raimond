using Dkd.Infra.Core.Exceptions;

namespace Microsoft.AspNetCore.Mvc.Filters;

/// <summary>
/// Exception interceptor for intercepting exceptions with StatusCode >= 500
/// </summary>
public sealed class CustomExceptionFilterAttribute(ILogger<CustomExceptionFilterAttribute> logger, IWebHostEnvironment env) : ExceptionFilterAttribute
{
    public override void OnException(ExceptionContext context)
    {
        ...
        else
        {
            ...
            detial = env.IsDevelopment() ? exception.GetDetail() : $"System Exception, please contact administrator({eventId})";
